! function(e, t) {
    ...
    return function(e) {
        ...
        var i = Object.assign || function(e) {
            ...
            v = function() {
                ...
                if (e && (p = !0), p) return m = (0, f.default)(m, b), (0, d.default)(m, b.once), m
            },
            y = function() {
                m = (0, l.default)(), v()
            };
        e.exports = {
            init: function(e) {
                ...
                }), b.throttleDelay)), b.disableMutationObserver || u.default.ready("[data-aos]", y), m)
            },
            refresh: v,
            refreshHard: y
        }
        ...
        (function(t) {
            ...
            function o(e, t, o) {
                ...
                function u(e) {
                    var o = e - y;
                    return void 0 === y || o >= t || o < 0 || O && e - g >= p
                }

                function s() {
                    var e = k();
                    return u(e) ? d(e) : void(v = setTimeout(s, function(e) {
                        var o = t - (e - y);
                        return O ? w(o, p - (e - g)) : o
                    }(e)))
                }

                function d(e) {
                    return v = void 0, j && l ? i(e) : (l = m = void 0, b)
                }
                ...
                function f() {
                    ...
                    if (l = arguments, m = this, y = e, o) {
                        ...
                        if (O) return v = setTimeout(s, t), i(y)
                    }
                ...
                return t = r(t) || 0, n(o) && (x = !!o.leading, p = (O = "maxWait" in o) ? h(r(o.maxWait) || 0, t) : p, j = "trailing" in o ? !!o.trailing : j), f.cancel = function() {
                    void 0 !== v && clearTimeout(v), g = 0, l = y = m = v = void 0
                }, f.flush = function() {
                    return void 0 === v ? b : d(k())
                }, f
            }
        ...
        (function(t) {
            ...
            e.exports = function(e, t, n) {
                ...
                function u(e) {
                    var o = e - y;
                    return void 0 === y || o >= t || o < 0 || O && e - k >= p
                }
                ...
                function s() {
                    ...
                    return u(e) ? d(e) : void(v = setTimeout(s, function(e) {
                        var o = t - (e - y);
                        return O ? h(o, p - (e - k)) : o
                    }(e)))
                }

                function d(e) {
                    return v = void 0, j && l ? r(e) : (l = m = void 0, b)
                }
                ...
                function f() {
                    ...
                    if (l = arguments, m = this, y = e, o) {
                        ...
                        if (O) return v = setTimeout(s, t), r(y)
                    }
                    return void 0 === v && (v = setTimeout(s, t)), b
                }
                var l, m, p, b, v, y, k = 0,
                ...
                return t = i(t) || 0, o(n) && (x = !!n.leading, p = (O = "maxWait" in n) ? g(i(n.maxWait) || 0, t) : p, j = "trailing" in n ? !!n.trailing : j), f.cancel = function() {
                    void 0 !== v && clearTimeout(v), k = 0, l = y = m = v = void 0
                }, f.flush = function() {
                    return void 0 === v ? b : d(w())
                }, f
            }
        }).call(t, function() {
            return this
        ...
        t.default = {
            ...
            ready: function(e, t) {
                var o = window.document,
                    a = new(n())(i);
                r = t, a.observe(o.documentElement, {
                    childList: !0,
                    subtree: !0,
                    removedNodes: !0
                })
    ...
    function() {
        ...
        if (e) {
            ...
            if (t) {
                var o = new bootstrap.Collapse(t, {
                        toggle: !1
                    }),
                    n = t.querySelectorAll("a");
                for (var i of n) i.addEventListener("click", (function(e) {
                    o.hide()
                }))
            }
            var r = function() {
